...
public class Converter
{
    ...
    public void ConvertDocxToDoc(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".docx", ".doc") + "\" \"" + savingName + "\"";
    ...
    public void ConvertDocxToRtf(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".docx", ".rtf") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertDocxToOdt(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".docx", ".odt") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertDocxToPdf(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".docx", ".pdf") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertDocxToTxt(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".docx", ".txt") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertDocToDocx(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".doc", ".docx") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertDocToRtf(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".doc", ".rtf") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertDocToOdt(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".doc", ".odt") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertDocToPdf(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".doc", ".pdf") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertDocToTxt(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".doc", ".txt") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertPdfToDocx(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".pdf", ".docx") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertTxtToPdf(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".txt", ".pdf") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertTxtToDocx(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".txt", ".docx") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertTxtToOdt(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".txt", ".odt") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertTxtToRtf(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".txt", ".rtf") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertTxtToDoc(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".txt", ".doc") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertOdtToDocx(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".odt", ".docx") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertOdtToPdf(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".odt", ".pdf") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertOdtToTxt(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".odt", ".txt") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertOdtToRtf(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".odt", ".rtf") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertOdtToDoc(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".odt", ".doc") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertRtfToTxt(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".rtf", ".txt") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertRtfToPdf(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".rtf", ".pdf") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertRtfToOdt(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".rtf", ".odt") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertRtfToDoc(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".rtf", ".doc") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertRtfToDocx(string inputFilePath, string saveDirectory, string savingName)
    {
        ...
        using (var sw = renameProcess.StandardInput)
        {
            if (sw.BaseStream.CanWrite)
            {
                var renameCommand = "rename \"" + saveFolderPath + "\\" + Path.GetFileName(inputFilePath).Replace(".rtf", ".docx") + "\" \"" + savingName + "\"";
                sw.WriteLine(renameCommand);
            }
        }
    ...
    public void ConvertJpgToGif(string sourcePath, string targetDirectory, string conv)
    {
        ...
        using (Image image = Image.FromFile(sourcePath))
        {
            ...
            string directoryName = targetDirectory;
    ...
    public void ConvertJpgToPng(string sourcePath, string targetDirectory, string conv)
    {
        // Load the image.
        using (Image image = Image.FromFile(sourcePath))
        {
